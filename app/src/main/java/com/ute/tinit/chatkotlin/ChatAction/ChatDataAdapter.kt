    ...
    override fun getItemViewType(position: Int): Int {
        ...
        override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
            ...
            when (viewType) {
                ...
                IMAGE_YOU -> {
                    val v3 = inflater.inflate(R.layout.layout_holder_image_you, viewGroup, false)
                    viewHolder = HolderImageYou(v3)
                }

                else -> {
                    val v4 = inflater.inflate(R.layout.layout_holder_image_me, viewGroup, false)
                    viewHolder = HolderImageMe(v4)
                }
            }
            return viewHolder
        }
