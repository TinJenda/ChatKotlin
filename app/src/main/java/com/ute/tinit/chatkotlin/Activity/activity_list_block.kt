...
import kotlinx.android.synthetic.main.layout_activity_list_block.*

class activity_list_block : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.layout_activity_list_block)
